...
function Main() {
  return (
    <main className="flex h-full w-full items-center justify-center md:max-h-dvh">
      <div className="flex h-full flex-col items-start justify-start gap-6 md:flex-row">
