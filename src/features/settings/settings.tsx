...
const Settings = () => {
  ...
  return (
    <main className="bg-entity-bg border-standart-border shadow-standart backdrop-blur-custom mx-auto h-full max-w-7xl self-stretch rounded-4xl border-1 py-6 md:max-h-dvh">
