      ...
      <div className="flex flex-row flex-wrap gap-20">
        <div>
          ...
          <div className="mt-2 flex flex-row flex-wrap gap-12">
            ...
            >
              <div
                className={`shadow-standard rounded-dynamic aspect-square w-32 bg-[#100F17] ${theme === "dark" ? "border-active-border border-size-dynamic" : "border-standard-border border-size-dynamic"}`}
              />
              <span>Dark</span>
            </div>
            <div
            ...
            >
              <div
                className={`shadow-standard rounded-dynamic aspect-square w-32 bg-[#291F34] ${theme === "lavender" ? "border-active-border border-size-dynamic" : "border-standard-border border-size-dynamic"}`}
              />
              <span>Lavender</span>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="mt-2 flex flex-row flex-wrap gap-12">
            ...
            >
              <div
                className={`shadow-standard rounded-dynamic aspect-square w-32 bg-[#F6F7F8] ${theme === "light" ? "border-active-border border-size-dynamic" : "border-standard-border border-size-dynamic"}`}
              />
              <span>Light</span>
            </div>
            ...
            >
              <div
                className={`shadow-standard rounded-dynamic aspect-square w-32 bg-[#D2EBE6] ${theme === "mint" ? "border-important border-size-dynamic" : "border-standard-border border-size-dynamic"}`}
              />
              <span>Mint</span>
            </div>
          </div>
