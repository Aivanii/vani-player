    ...
    <>
      {createPortal(
        <>
          ...
          <div
            className={`border-standard-border shadow-standard backdrop-blur-dynamic rounded-dynamic border-size-dynamic duration-dynamic fixed z-10000 flex flex-col overflow-hidden backdrop-opacity-100 transition-all ${isOpen ? "scale-100 opacity-100" : "scale-0 opacity-0"}`}
