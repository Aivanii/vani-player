    ...
    <>
      {createPortal(
        <>
          ...
          <div
            className={`border-standart-border shadow-standart backdrop-blur-dynamic fixed z-10000 rounded-2xl border-1 p-4 backdrop-opacity-100 transition-all duration-500 ${isOpen ? "scale-100 opacity-100" : "scale-0 opacity-0"}`}
