...
const Recommendations = observer(() => {
  ...
  return (
    <div className="shadow-standart bg-entity-bg border-standart-border relative z-0 mx-auto mb-2 block h-max w-dvw self-stretch overflow-hidden rounded-4xl border-1 px-2 py-6 backdrop-blur-sm sm:w-full sm:px-6 md:max-h-[540px]">
      <div className="py-2">
