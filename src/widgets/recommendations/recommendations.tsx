...
const Recommendations = observer(() => {
  ...
  return (
    <div className="shadow-standart inner-glow bg-entity-bg border-standart-border backdrop-blur-dynamic rounded-dynamic border-size-dynamic relative z-0 mx-auto mb-2 block h-max w-dvw self-stretch overflow-hidden px-2 py-6 sm:w-full sm:px-6 md:max-h-[540px]">
      <div className="py-2">
