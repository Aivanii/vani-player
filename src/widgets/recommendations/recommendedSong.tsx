...
const RecommendedSong = ({
  ...
  return (
    <div
      key={song.id}
      className={`inner-glow no-class-button border-standard-border bg-draggable-elem-bg hover:hover-glow-enhanced rounded-dynamic border-size-dynamic no-scale duration-dynamic backdrop-opacity-100 transition-all hover:scale-105 ${
        recsStyle === "vertical"
