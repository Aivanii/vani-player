...
const MusicSearch = observer(() => {
  ...
  return (
    <div className="relative z-100 mr-5 ml-auto flex h-full items-center justify-center">
      ...
      {isMenuOpen && (
        <>
          <div className="shadow-standard border-standard-border bg-entity-bg backdrop-blur-dynamic rounded-dynamic border-size-dynamic absolute top-full left-0 z-1100 w-full p-4 backdrop-opacity-100">
            <ul
