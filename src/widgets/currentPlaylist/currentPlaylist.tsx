...
const CurrentPlaylist = observer(() => {
  ...
  return (
    <>
      <aside className="shadow-standart bg-entity-bg border-standart-border backdrop-blur-dynamic rounded-dynamic relative z-0 block h-full w-dvw max-w-4xl self-stretch border-1 py-4 md:max-h-[820px] md:w-sm lg:w-md">
