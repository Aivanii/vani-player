  ...
  return (
    <>
      {!isHidden &&
        createPortal(
          <div
            className="fixed top-1/2 left-1/2 flex h-full w-full -translate-1/2 items-center justify-center"
            onClick={(event) => {
              if (event.currentTarget === event.target) setIsHidden(true);
            }}
          >
            <div className="bg-entity-bg border-standart-border shadow-standart flex h-[80vh] max-h-320 w-[80vw] max-w-7xl flex-col items-center justify-center rounded-4xl border-1 px-12 backdrop-blur-2xl">
                ...
                <ul className="my-16 flex w-full flex-col gap-4 text-2xl">
                  <li className="border-color-primary flex w-full items-center justify-between border-t-1 px-4 pt-4">
                    ...
                    <div className="flex w-1/3 gap-x-2">
                      <kbd className="border-standart-border flex items-center justify-center rounded-md border-1 bg-[var(--gradient-variant-1)] px-2">
                        Space
                      </kbd>
                      ,
                      <kbd className="border-standart-border rounded-md border-1 bg-[var(--gradient-variant-1)] p-2">
                        Enter
                      </kbd>
                    </div>
                  </li>
                  <li className="border-color-primary flex w-full items-center justify-between border-t-1 px-4 pt-4">
                    ...
                    <div className="flex w-1/3 gap-x-2">
                      <kbd className="border-standart-border mr-auto flex min-w-min items-center justify-start rounded-md border-1 bg-[var(--gradient-variant-1)] px-2">
                        m
                      </kbd>
                    </div>
                  </li>
              ...
              <div className="py-6">
                <button className="px-6 py-2" onClick={() => setIsHidden(true)}>
                  close
                </button>
              </div>
            </div>
